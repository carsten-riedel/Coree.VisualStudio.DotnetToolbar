...
namespace Coree.VisualStudio.DotnetToolbar
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandDotnetTest : CommandBase
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CommandDotnetTest(AsyncPackage package, OleMenuCommandService commandService) : base(package, commandService)
        {
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        /// </summary>
        public static CommandDotnetTest Instance
        {
            get;
            private set;
        }
        ...
        public static async System.Threading.Tasks.Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new CommandDotnetTest(package, commandService);
        }
